...
class NativeMathApi {
  /// Constructor for [NativeMathApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NativeMathApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<double> add(double a, double b) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.flutter_math.NativeMathApi.add$pigeonVar_messageChannelSuffix';
  ...
  Future<double> subtract(double a, double b) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.flutter_math.NativeMathApi.subtract$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<double> multiply(double a, double b) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.flutter_math.NativeMathApi.multiply$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<double> divide(double a, double b) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.flutter_math.NativeMathApi.divide$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
